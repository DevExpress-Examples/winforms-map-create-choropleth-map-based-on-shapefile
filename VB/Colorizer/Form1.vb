...
Namespace Colorizer
    ...
    Public Partial Class Form1
        ...
        Private Function CreateGDPColorizer() As ChoroplethColorizer
            ...
            colorizer.ColorItems.AddRange(New List(Of ColorizerColorItem) From {New ColorizerColorItem(Color.FromArgb(&H5F, &H8B, &H95)), New ColorizerColorItem(Color.FromArgb(&H79, &H96, &H89)), New ColorizerColorItem(Color.FromArgb(&HA2, &HA8, &H75)), New ColorizerColorItem(Color.FromArgb(&HCE, &HBB, &H5F)), New ColorizerColorItem(Color.FromArgb(&HF2, &HCB, &H4E)), New ColorizerColorItem(Color.FromArgb(&HF1, &HC1, &H49)), New ColorizerColorItem(Color.FromArgb(&HE5, &HA8, &H4D)), New ColorizerColorItem(Color.FromArgb(&HD6, &H86, &H4E)), New ColorizerColorItem(Color.FromArgb(&HC5, &H64, &H50)), New ColorizerColorItem(Color.FromArgb(&HBA, &H4D, &H51))})
            Return colorizer
        End Function
